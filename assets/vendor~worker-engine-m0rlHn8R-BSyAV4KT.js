...
`],{type:`application/javascript`})),{type:`module`}),{wasmUrl:e,logger:n,fontFallback:i}),c=URL.createObjectURL(new Blob([`function rgbaToBmpBlob(rgba, width, height) {
...
`],{type:`application/javascript`})),l=new m(r??2,c,n);return new a(s,{imageConverter:o(l),logger:n})}export{s as t};