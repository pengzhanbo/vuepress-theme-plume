...
import type { ThemeHomeHeroDarkVeil } from '../../../shared/index.js'
import { Mesh, Program, Renderer, Triangle, Vec2 } from 'ogl'
import { onMounted, onUnmounted, useTemplateRef, watch } from 'vue'

const props = withDefaults(defineProps<ThemeHomeHeroDarkVeil>(), {
  hueShift: 0,
  noiseIntensity: 0,
  scanlineIntensity: 0,
  speed: 0.5,
...
<template>
  <canvas ref="canvasRef" class="home-hero-effect-dark-veil" />
</template>

<style scoped>
.home-hero-effect-dark-veil {
  position: absolute;
  display: block;
  width: 100%;
  height: 100%;
