...
export const PRESET: TagsColorsItem[] = [
  ...
  ['#cc6699', '#be3f7f', 'rgba(161, 54, 107, 0.2)'],
  ['#55aaee', '#2391e9', 'rgba(21, 123, 206, 0.2333)'],
  ['#9933cc', '#aa56d5', 'rgba(179, 102, 217, 0.3)'],
  ['#cc3366', '#d55680', 'rgba(217, 102, 140, 0.3)'],
  ['#cc9966', '#be7f3f', 'rgba(161, 107, 54, 0.2)'],
  ['#9999cc', '#7171b8', 'rgba(83, 83, 167, 0.3)'],
  ['#66cccc', '#3fbebe', 'rgba(54, 161, 161, 0.2)'],
  ['#3366cc', '#5680d5', 'rgba(102, 140, 217, 0.3)'],
  ['#339999', '#41c0c0', 'rgba(83, 198, 198, 0.2)'],
  ['#a6623b', '#c17950', 'rgba(199, 134, 97, 0.2411)'],
  ['#8ecaef', '#55afe7', 'rgba(42, 155, 225, 0.347)'],
]
