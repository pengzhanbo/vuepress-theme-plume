        ...
        output: {
          codeSplitting: {
            groups: [
              ...
              { name: 'vendor', test: excludeDynamicImport, priority: 90, entriesAware: true, minModuleSize: 28000, entriesAwareMergeThreshold: 100000 },
              { name: 'common', test: (id: string) => excludeDynamicImport(id) ?? true, priority: 10, minShareCount: 3, minSize: 100000 },
            ],
          },
        },
      },
